...
class RecurrentAutoencoder(torch.nn.Module):
    def __init__(self, seq_len, vocab_size, embed_dim=16):
        ...
        self.char_embedding = torch.nn.Embedding(vocab_size, self.char_embedding_dim) # +2 
...
class FactorizationMachineModel(torch.nn.Module):
    ...
    def __init__(self, field_dims, vocab_size, embed_dim):
        ...
        self.autoencoder3 = RecurrentAutoencoder(38, vocab_size, self.ae_dim) # carrier 
    ...
    def forward(self, x, additional, column):
        ...
        pred_seq2, hidden2 = self.autoencoder(additional[:,149:199]) # carrier
        pred_seq3, hidden3 = self.autoencoder(additional[:,199:]) # make
        ...
        x = linear_x + self.fm(feat_embedding)
